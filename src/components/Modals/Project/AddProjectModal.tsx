...
function AddProjectModal({ className, children, ...props }: AddProjectModalProps) {
    ...
    const createProjectMutation = useMutation<any, any, any, any>((payload) => {
    ...
    return (
        <Modal isActive={props.isActive}>
            ...
            <ModalBody>
                <form onSubmit={handleSubmit((data) => createProjectMutation.mutate(data))} className="flex flex-col gap-4">
