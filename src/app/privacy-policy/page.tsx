	...
	return (
		<div>
			...
			<p>
				...
				Servern von AWS verarbeitet. Hierbei k&ouml;nnen auch personenbezogene Daten an das
			...
			<p>
				Die Verwendung von AWS erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Wir
				...
				DSGVO und &sect; 25 Abs. 1 TTDSG, soweit die Einwilligung die Speicherung von
